...
export type FullArraySpec = {
    ...
    data: Int16Array | Int32Array | Uint16Array | Uint32Array | Float32Array;
    numComponents?: number;
    type?: number;
    size?: number;
    normalize?: boolean;
...
// export function createProgramInfo(gl: WebGL2RenderingContext, shaderSources: string[], opt_attribs?: ProgramOptions | string[] | ErrorCallback, opt_errorCallback?: ErrorCallback): ProgramInfo;
