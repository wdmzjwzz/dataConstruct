...
export function isBuffer(t: any) {
  return typeof WebGLBuffer !== "undefined" && t instanceof WebGLBuffer;
}

export function isRenderbuffer(t: any) {
  return (
    typeof WebGLRenderbuffer !== "undefined" && t instanceof WebGLRenderbuffer
  );
}

export function isShader(t: any) {
  return typeof WebGLShader !== "undefined" && t instanceof WebGLShader;
}

export function isTexture(t: any) {
  return typeof WebGLTexture !== "undefined" && t instanceof WebGLTexture;
}

export function isSampler(t: any) {
